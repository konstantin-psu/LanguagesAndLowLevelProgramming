 ...
 * Basic constants:
 */
#define WORDLOG2          5             // Log2 size (in bits) of a word
#define WORDSIZE          (1<<WORDLOG2) // Size of a word (in bits)
#define bytesToWords(b)   ((b)>>2)      // Number of words in b bytes
...
// The following operations must be implemented as macros rather than
// inline functions because this code will be #included in assembly code
// too, and the assembler doesn't understand C syntax ...
