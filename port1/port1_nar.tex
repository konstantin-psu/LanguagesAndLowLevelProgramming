...
I attempted to write simple "editor" that allows to enter and delete text (unfortunately without navigation keys). 
I also reused all the functions we written for the first lab (setAttr, cls, outc, outhex), by adding videoasm to
the hello.

Input is easily by reusing provided "simpleio" library, 
