...
\newcommand{\hmwkTitle}{Portfolio submission\ \#2, Topic 5}
\newcommand{\hmwkDueDate}{April 22, 2016}
...
Describe the motivation,implementation, and application of microkernel abstractions for 
managing address spaces,threads, and interprocess com-munication (IPC).
